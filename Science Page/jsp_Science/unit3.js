...
function setAvailableQuestions() {
    const totalQuestion = unit3.length;
    for (let i = 0; i < totalQuestion; i++) {
        availableQuestions.push(unit3[i]);
    }
}
...
function getNewQuestion() {
    //question number
    questionNumber.innerHTML = "Question " + (questionContainer + 1) + " of " + unit3.length;
...
function next() {
    if (questionCounter === unit3.length) {
...
function quizResult() {
    resultBox.querySelector(".total-question").innerHTML = unit3.length;
