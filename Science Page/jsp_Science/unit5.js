...
function setAvailableQuestions() {
    const totalQuestion = unit5.length;
    for (let i = 0; i < totalQuestion; i++) {
        availableQuestions.push(unit5[i]);
    }
}
...
function getNewQuestion() {
    //question number
    questionNumber.innerHTML = "Question " + (questionContainer + 1) + " of " + unit5.length;
...
function next() {
    if (questionCounter === unit5.length) {
...
function quizResult() {
    resultBox.querySelector(".total-question").innerHTML = unit5.length;
