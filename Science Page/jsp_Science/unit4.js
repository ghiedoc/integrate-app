...
function setAvailableQuestions() {
    const totalQuestion = unit4.length;
    for (let i = 0; i < totalQuestion; i++) {
        availableQuestions.push(unit4[i]);
    }
}
...
function getNewQuestion() {
    //question number
    questionNumber.innerHTML = "Question " + (questionContainer + 1) + " of " + unit4.length;
...
function next() {
    if (questionCounter === unit4.length) {
...
function quizResult() {
    resultBox.querySelector(".total-question").innerHTML = unit4.length;
