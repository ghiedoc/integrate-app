...
function getNewQuestion() {
    //question number
    questionNumber.innerHTML = "Question " + (questionContainer + 1) + " of " + quiz.length;
...
function backTHome() {
    const totalQuestion = quiz.length;
    const attemptMade = attempt;
    const correctAns = correctAnswers;
    const wrongAns = attempt - correctAnswers;
    const totScore = correctAnswers;
    console.log(totalQuestion);
    console.log(attemptMade);
