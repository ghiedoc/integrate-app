...
function setAvailableQuestions() {
    const totalQuestion = unit2.length;
    for (let i = 0; i < totalQuestion; i++) {
        availableQuestions.push(unit2[i]);
    }
}
...
function getNewQuestion() {
    //question number
    questionNumber.innerHTML = "Question " + (questionContainer + 1) + " of " + unit2.length;
...
function next() {
    if (questionCounter === unit2.length) {
...
function quizResult() {
    resultBox.querySelector(".total-question").innerHTML = unit2.length;
